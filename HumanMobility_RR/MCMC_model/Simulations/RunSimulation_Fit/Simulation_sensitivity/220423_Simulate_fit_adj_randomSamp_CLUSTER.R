...
save(dat.in2,file=paste0("./MCMC_model/Simulations/output/rand_downSamp/dat.in2",scale,".",iters,".",boot,"_adj.RData"))
save(dat.in.all,file=paste0("./MCMC_model/Simulations/output/rand_downSamp/dat.in.all",scale,".",iters,".",boot,"_adj.RData"))
save(sim.ans,file=paste0("./MCMC_model/Simulations/output/rand_downSamp/sim.ans.",scale,".",iters,".",boot,"_adj.RData"))###SAVE OUTPUT
}
###############################################################################
