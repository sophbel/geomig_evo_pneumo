...
for (chain in 1){
  load(paste0("./MCMC_model/Simulations/output/rand_downSamp/sim.ans.",scale,".",iters,".",boot,"_adj2.RData"))
  load(paste0("./MCMC_model/Simulations/output/rand_downSamp/dat.in2",scale,".",iters,".",boot,"_adj2.RData"))
  load(paste0("./MCMC_model/Simulations/output/rand_downSamp/dat.in.all",scale,".",iters,".",boot,"_adj2.RData"))
...
for(post in 1:nsim){
  ...
  ### sweep by population size:
  ###### TranMatArrayA2.mrcaTRUE<-sweep(TranMatArrayA,1,mrcaVec,"*")
