...
for (chain in 1){
  load(paste0("./MCMC_model/Simulations/output/wrongGenTime/sim.ans.",scale,".",iters,".",boot,"_adj.RData"))
  load(paste0("./MCMC_model/Simulations/output/wrongGenTime/dat.in2",scale,".",iters,".",boot,"_adj.RData"))
  load(paste0("./MCMC_model/Simulations/output/wrongGenTime/dat.in.all",scale,".",iters,".",boot,"_adj.RData"))
