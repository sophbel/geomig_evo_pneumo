...
par1<-runif(1,0,3)
# par2<-runif(1,0,3)
par2_9<-runif(8,0,0.9999)
startPar<-c(par1,par2_9)
ans.munic <- MCMC(likFunc.munic,initial = startPar,nsteps  = iters,kernel  = kernel_normal(scale = .08),thin=5)
save(ans.munic,file=paste0("./MCMC_model/outputs/gravity_model/grav_g/ans.munic",chain,".",iters,".08_gravity_adj_g",".RData"))
