...
if(categorical==TRUE){
  load("./RelativeRisk/files/matplot_specificRange.noSub_cat_mulTrees_260923.RData")
...
# save(mat_sub_genomic,file="./RelativeRisk/files/mat_sub_genomic_cont_multiTrees.RData")
