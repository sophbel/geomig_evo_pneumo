...
#! Name of the job:
#SBATCH -J Fitness_Pert
#! Which project should be charged:
#SBATCH -A HSALJE-SL2-CPU
#! Output filename: %A means slurm job ID
#SBATCH --output=Fitness_Pert_%A.log
# Redirect error messages with: -e <file_name>
#SBATCH --error=Fitness_Pert_%A.err

#SBATCH -p "cclake,skylake"
...
application="srun Rscript MCMC_fitness_NVT_PCV7_PCV13.R"
