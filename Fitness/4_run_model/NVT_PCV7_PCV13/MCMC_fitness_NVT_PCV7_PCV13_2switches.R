...
## PCV7 introduction
data.MCMC$yearF0 = rep(2009, nb_countries) - first_year + 1

## PCV13 introduction (vector of length countries)
data.MCMC$yearIntroduction = rep(2011, nb_countries) - first_year + 1
...
name_file = 'Output_per_provice_NVT_PCV7_PCV13_swicthes2009and2011'
print(name_file)
