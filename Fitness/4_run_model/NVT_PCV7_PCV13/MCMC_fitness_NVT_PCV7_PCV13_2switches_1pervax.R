...
for(delay in delays){
  ...
  if(delay >= 0) name_file = paste0('Output_per_provice_NVT_PCV7_PCV13_swicthes2009and2011_1pervax_plus', abs(delay))
  if(delay < 0) name_file = paste0('Output_per_provice_NVT_PCV7_PCV13_swicthes2009and2011_1pervax_minus', abs(delay))
  print(name_file)
